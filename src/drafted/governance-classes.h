 ...
 *
 *   // network
 *   CPoixNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.poix.online/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CPoixNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: PoixNetwork
// //   -- signature requirements : Key1(User)
// class CPoixNetworkVariable : public CGovernanceObject
// {
// private:
