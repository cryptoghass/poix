...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "PoixNetwork") type = PoixNetwork;
    if(strType == "PoixNetworkVariable") type = PoixNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == PoixNetwork) s = "PoixNetwork";
    if(type == PoixNetworkVariable) s = "PoixNetworkVariable";
