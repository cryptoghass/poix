    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("POIX-light"), QVariant("light"));
    ui->theme->addItem(QString("POIX-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("POIX-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("POIX-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("POIX-traditional"), QVariant("trad"));
