    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Poix Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Poix address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and poix: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Poix Core"), this);
    aboutAction->setStatusTip(tr("Show information about Poix Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Poix Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Poix addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Poix addresses"));
    ...
    openAction->setStatusTip(tr("Open a poix: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Poix Core help message to get a list with possible Poix Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Poix Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Poix network", "", count));
    } else {
...
{
    QString strTitle = tr("Poix Core"); // default title
