    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Poix Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Poix Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  poix-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Poix in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 POIX, 0.1 POIX, 1 POIX and 10 POIX -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://poixpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://poixpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Poix Core is shutting down...") + "<br /><br />" +
