/* src/config/poix-config.h.  Generated from poix-config.h.in by configure.  */
/* src/config/poix-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef POIX_CONFIG_H

#define POIX_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/poixpay/poix/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Poix Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Poix Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "poixcore"
