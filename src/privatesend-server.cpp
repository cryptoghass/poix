...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Poix related functionality
...
/*
    ...
    allow endless transaction that would bloat Poix and make it unusable. To
