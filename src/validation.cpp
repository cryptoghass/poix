...
CAmount GetBlockSubsidy(int nPrevBits, int nPrevHeight, const Consensus::Params& consensusParams, bool fSuperblockPartOnly)
{
    ...
    if (nPrevHeight == 0) {
        ...
        if(nSubsidyBase > 450000) nSubsidyBase = 450000;
        else if(nSubsidyBase < 450000) nSubsidyBase = 450000;
    } else if (nPrevHeight < 17000 || (dDiff <= 75 && nPrevHeight < 24000)) {
        // CPU mining era
        // 11111/(((x+51)/6)^2)
        nSubsidyBase = (11111.0 / (pow((dDiff+3000.0)/6.0,2.0)));
        if(nSubsidyBase > 10) nSubsidyBase = 10;
        else if(nSubsidyBase < 5) nSubsidyBase = 5;
    } else {
        // GPU/ASIC mining era
        // 2222222/(((x+2600)/9)^2)
        nSubsidyBase = (2222222.0 / (pow((dDiff+15000.0)/9.0,2.0)));
        if(nSubsidyBase > 10) nSubsidyBase = 10;
        else if(nSubsidyBase < 5) nSubsidyBase = 5;
    }
