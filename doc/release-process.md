...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the poix.online server

- Update poix.online

- Announce the release:

  - Release on Poix forum: https://www.poix.online/forum/topic/official-announcements.54/
...
- Notify flare so that he can start building [the PPAs](https://launchpad.net/~poix.online/+archive/ubuntu/poix)
