...
This mechanism has been integrated into Bitcore-Node-Poix which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/poixpay/insight-api-poix#web-socket-api](https://github.com/poixpay/insight-api-poix#web-socket-api)
* API: [https://github.com/poixpay/insight-api-poix#instantsend-transactions](https://github.com/poixpay/insight-api-poix#instantsend-transactions)
...
By default, the Poix Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Poix Core daemon:
