...
Only requiring some minor changes is poix.cpp.
...
Changes to poix.cpp
----------------------
poix.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
